...
<div>
    ...
    <hr>
     ...
     <ul>
       <li>
         Fall 2016: Naively applied to jobs on the University Website (mostly). "How hard can this be? I have a good degree from a top 5 institution with a well-known advisor and respectable publication record."
       </li>
       <li>
         Winter 2016/Spring 2017: While I didn't get any hits to start, I figured I would pursue a possible career as a Start-Up entrepreneur promoting the technology developed during my Ph.D. "You miss 100% of the shots you don't take", as Michael Scott once said.
       </li>
       <li>
         Summer 2017: Parallel goals. Applied for Chemical Engineering jobs more seriously and also pursued the Start-Up through an <a href="https://www.nsf.gov/news/special_reports/i-corps/" target = "_blank">I-Corps program</a>. The most promising avenue would be my career.
       </li>
       <li>
         Fall 2017: Start-Up is atarted looking very difficult, seriously applied to Chemical Engineering jobs. I landed my first on-site interview with Micron (got denied).
       </li>
       <li>
         Winter/Spring 2018: Defended my Ph.D. and pursued the Start-Up full-time as a post-doc.
       </li>
       <li>
         Summer 2018: Quit the Start-Up. Vacationed as Brittany's trophy boyfriend for a bit while raising the pup. Eventually developed the resume skills for Data Science and started applying vigorously.
       </li>
       <li>
         Fall 2018: Participated in an <a href="https://www.insightdatascience.com/" target = "_blank">Insight Data Science Fellowship Program</a> that led to three offers. I accepted the one for Strong Analytics.
       </li>
     </ul>
     <br>
