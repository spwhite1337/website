<template>
  <div>
    ...
    <hr>
        ...
        his defense, I tend to hog the ball. In my defense, his shot was terrible.). After one session, we went out for
        post-game beers and he revealed he was an English major. Someone asked about his favorite American book and he
        said, "The Great Gatsby". And I jokingly replied, "Did that inspire you to move to America and persue the
        ...
        <br><br>
        “Civilization’s going to pieces,” broke out Tom violently. “I’ve gotten to be a terrible pessimist about
        ...
        <br><br>
        “Tom’s getting very profound,” said Daisy, with an expression of unthoughtful sadness. “He reads deep books
        ...
        “Well, these books are all scientific,” insisted Tom, glancing at her impatiently. “This fellow has worked out
            the whole thing. It’s up to us, who are the dominant race, to watch out or these other races will
      ...
      <br>
        ...
        side of town.
        <br><br>
        Daisy Buchanan is Nick's cousin, the wife of Tom, and the eternal love interest of Gatsby. She is woefully
        ...
        of the novel.
        <br><br>
        To respond to the English Soccer teammate, the "high school" interpretation that connects The Great Gatsby to
        the American dream can be advanced through superior generalization. It's not just the American Dream that is
        getting called out in The Great Gatsy, it's the juvenile desire of social acceptance stemming from
        external validation. Gatsby, Daisy, and Tom have all "become Great" by society's standards but not their own.
