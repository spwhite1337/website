...
<div>
    ...
    <hr>
     ...
     <br><br>
     Works like Paradise Lost can really only be understood in a Christian context. If you approach them like "any other work of fiction" you'll lose sight of the insights people draw from the work and its affect on humanity's self-perception ("What does it all mean, man?!?").
     <hr>
     ...
     <br><br>
     God hears their cries and sends Michael (Archangel) down to help them out. Michael shows Adam the future which is a retelling of the Old Testament full of suffering and death. Michael concludes the poem by showing Adam a vision of Christ's sacrifice which gives him hope to carry on outside of paradise.
     <br><br>
     <em>
     ...
     <br><br>
     <hr>
     <b>Satan the Conspirator:</b> Focusing on Satan's plans, the poem starts with Satan's realization that he can never beat God and his army head on. He must instead underhandedly corrupt God's creation and win a game with rules he sets himself. Adam and Eve didn't have a chance because they were ultimately a tool for Satan's game.
     <br><br>
     The accusation John Milton leverages at Satan is the same structure that all prophets leverage against their enemy, "You are evil and motivated by revenge. So you are just going to pursue your goal without any ethical restraints and must be stopped!". More commonly, this takes the form of worshipping idols or false gods - similar to 'playing by rules you're not supposed to play'. In Milton's vision, the evil behavior is a product of his evil nature rather than accidental intentions that spiral off into evilness.
     <br><br>
     ...
     <em>
       "Then with expanded wings he stears his flight <br>
        ...
        Of thundring Ætna, whose combustible <br>
        ...
        Both glorying to have scap't the Stygian flood <br>
        As Gods, and by thir own recover'd strength, <br>
        Not by the sufferance of supernal Power."
     </em>
     <br><br>
     The explicit depiction of Satan as evil by nature (and powerful) is not exactly accepted by the Catholic Church. There, evil does not exist in itself as all existence is a product of God and therefore good. However, Milton either disagreed with this theology or simplified it for use as a narrative device. The conniving, conspiracizing, underhanded Satan is in direct contrast to an honorable, just, and honest enemies found in other epics. The absolute power of these traits is too much for man alone, but trivial for God and/or Jesus to smite down.
     <br><br>
     If you look closely, you'll find this narrative structure all over contemporary society and especially in politics. Hillary Clinton was resentful from her loss to Obama so she cheated to beat Bernie Sanders and tried to undermine the 'rules' of democracy. Donald Trump colluded with Russia to manipulate the public and the Republicans gerrymandered districts to get elected. Those two examples illustrate the profound difficulty we have to decouple 'evil' from 'evil behavior'. In our eyes, an evil person can never do something good and evil behavior isn't enacted by good people. In contrast, John Milton works diligently to decouple these behaviors in his depiction of Adam and Eve. They betray God but not due to their intrinsic evil nature but due to their intrinsic shortcomings.
     <br><br>
     <b>Adam and Eve:</b> While the theological implications of Paradise Lost are far too much for me to swallow, the perspective he takes on Adam and Eve is worth a comment. They initially exist as effectively equals - sharing a blissful love in Paradise. Eve commits the first sin, but due to deception by Satan. Adam follows suit, but of his own volition.
     <br><br>
     This belief reflects the controversial portrayal of genders in Christianity. In essence, our differences are irrelevant before God but our roles in society manifest differently. Adam is created first implying his role is to be the 'face' or 'head' of the Garden as a leader in service of God. Eve is created from Adam implying she is in service to both Adam and God. Later on, this relationship is expanded to include Jesus in the hierarchy as well.
     <br><br>
     ...
     <em>
          ...
          Clust’ring, but not beneath his shoulders broad: <br>
          Shee as a veil down to the slender waist <br>
          Her unadorned golden tresses wore <br>
          Dishevell’d, but in wanton ringlets wav’d <br>
          As the Vine curls her tendrils, which impli’d <br>
          Subjection, but requir’d with gentle sway, <br>
          And by her yielded, by him best receiv’d, <br>
