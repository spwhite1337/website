...
<div>
    ...
    <hr>
     ...
     <ul>
       ...
       <li>
        (ii) "Bayesian Reasoning" or "Scientific Methods" to morally optimize our utility (whatever that is) based off some metric (<a href="https://en.wikipedia.org/wiki/Mere_addition_paradox" target = "_blank">whatever that is</a>) in accordance with "science".
       </li>
       <li>
        (iii) When "science" the object or the institution is used as a substitute for truth, objectivity, credibility, authority, etc.
       </li>
       <li>
        (iv) The vast majority of nutritionists.
       </li>
       <li>
        (v) Whenever science (i.e. a physical description of the universe) is referenced during discussions of metaphysics (descriptions about said physical description) popularized by atheist vs. theist debates.
       </li>
     </ul>
    ...
    <img :src="getImgUrl('steve_shapin.jpg')" alt="SteveShapin" width="25%">
     ...
     <ul>
       ...
       <li>
         There is no stable, coherent scientific method nor is there scientific genius. Problems are identified collectively from interactions between the institution of science and the lay-public (or, in modern times, industry and the government) then solutions are 'found' when the problem dissolves.
       </li>
       <li>
         Science is not pure thought but that it is <em>practice</em>, that the hand is as important as the head, or even that the head follows the hand.
       </li>
     </ul>
     It is also important to highlight the non-uniqueness of physical-metaphysical connections that are claimed by the umbrella of "science". Does science tell us what is real? Or do we decide what is real then describe it scientifically? Is the scientific methodology exhaustive in this domain, or are other tools necessary? Consider the following quotes by famous scientists on the metaphysical implications of the model of the universe stemming from the scientific institution:
     <br><br>
     <ul>
       <li>
        <em>
    ...
    <br><br>
    In truth, it is silly to collapse science and metaphysics into the same domain just as it is silly for <a href="https://creationmuseum.org/" target= "_blank">Creationists</a> to separate them entirely. They are connected in a complicated fashion that modern institutions cannot stably define. I would encourage you to look elsewhere.
   ...
   <ul>
     <li>
       First, such a man was said to be personally uninterested in the material rewards that might flow from genuine natural philosphy.
     </li>
     <li>
       Second, he must be humble. Reading "God's Book of Nature" engendered in the Christian virtuoso a "well-grounded docility servicable to religion".
     </li>
     <li>
       Third, the experimental philospher must be a man of honor to maintain the integrity of the project.
     </li>
     <li>
       Fourth, the experimental philosopher must be a devout Christian who identified his work as a form of religious practice. Boyle described experimental philosophers as 'priests of nature' with laboratories serving as places of 'divine worship'.
     </li>
   </ul>
   While strikingly different than how we view the 'ideal scientist' today. There is no doubt a pattern of criteria that transfers to modernity. Science is routinely rejected due to financial conflicts of interest ("true science" doesn't come from Monsanto, Big Pharma, or Big Oil). Science is routinely rejected on political grounds (racist science). Even within the Academy, science is dismissed when it comes from select institutions or select countries. There is clearly an 'ideal' scientist and corresponding affiliation that the public requires for credibility - it would be easier if we were more explicit about it like Boyle was.
   <br><br>
   Some might argue that the 'ideal' scientist would be fundamentally amoral. Pure objectivity. Spock from Star Trek. Nothing is off limits because science doesn't make moral judgments. This is a category mistake. Science, the descriptive model of the universe, does not contain moral values. But science, the institution or methodology, most certainty does. Behind every scientific experiment is an implication that we "ought" to be getting this knowledge. The knowledge cannot justify itself (if we're still talking about amoral descriptions), so it must be justified by something else - that something is the institution of science and the corresponding scientist.
   <br><br>
   The results are clearly in my favor, I can't identify a single scientific communicator who presents their results absent a moral message, but many who do:
   ...
   <br><br>
   <b>The Body of Science:</b> This is by far my favorite chapter because it connects the scientist's philosophy with their personal bodily care (health, nutrition, sleep, drink, smoking). Once credibility is earned, the natural philosopher is naturally questioned on 'how they do it' and the methods they use (if you can't guess from Shapin's themes) vary historically and culturally. If they're really good, they get asked about immortality (seriously).
   <br><br>
   Given the connection between diet/action in every ideology or religion documented - it should come as no surprise that experimental philosophy has its own associated habits and rituals related to diet and health. All of them through all time have all been backed by science (or the most credible source of knowledge of the natural world) and all of them enable the control of the material body with the mind in the same way experimental philosophy gains control of molecules once proper experimentation is complete. In order to credibly comment on the state of the material world one must be able to understand their own material body. Excesses of vice were not characteristic of the gentlemanly scholar, but rather an irrational brute. The exact balance between virtue and vice varied amongst thinkers with some demanding an ascetic ideal (Plato, Wittgenstein) while others believed moderation was yet another virtue to moderate.
   <br><br>
   <em>
     "That he did believe he had been in excess in his life a hundred times; which, considering his great age, did not amount to above once a year. When he did drink, he would drink to excess to have the benefit of vomiting, which he did easily... but he never was, nor could not endure to be, habitually a good fellow, i.e. to drink every day wine with company, which, though not to drunkeness, spoils the Brain." John Aubrey in his biography of Thomas Hobbes who blacked out and puked once a year like a bitch (I'm jk)
   </em>
   <br><br>
   ...
   <br><br>
   <em>
     "There has always been, and there probably always will be, an intimate connection between how people recognize good knowledge and how they conceive a good society. The relationship is not one of mere analogy; it is constitutive. The making of reliable, objective, and robust knowledge -- that is, for us, <u>science</u> -- is accomplished by communities of expert human beings -- <u>scientists</u> -- and it can produce anything but distorted knowledge: not <u>science</u> but ideology or dogma or error. Verity and virtue march in lock-step through history, as do error and evil. The Republic of Science is modeled on the City of God." Steven Shapin, Intro to Chapter 4.
   </em>
   <br><br>
   One can replace the underlined phrases with those for the appropriate era (e.g. Theology, priests, God's Word for the Scholastic Era) or for the vision you have for society. These broad "appeals to nature" are not unique to scientists and, in fact, are a ubiquitous part of how we interact with our community, our society, and the world:<br><br>
   <ul>
     <li>
     <em>
  ...
  <br><br>
  Always be wary when people support "Science backed policy" or "Evolution inspired politics" without independently outlining their end goals and inspirational beginnings.
  <br><br>
  <b>Concluding Remarks:</b> This book is a treat. It lifts the veil on some silly conceptions of science held by the broad public and also outlines the reasons for the pecularities of human institutions. The main value of the book stems from the elaboration of historical scientists' successes and the associated failures from extrapolating beyond those successes. Commonly referred to as the "Naturalistic Fallacy" or the inability for a descriptive model of the world to justify a prescriptive model is, was, and will remain an irresistible temptation for intellectuals of all stripes, institutions, and time periods. This is not to say a descriptive model is unimportant, but to properly bound its relevance to avoid false prophets and faulty moral reasoning.
  <br><br>
...
export default {
    ...
    methods: {
        getImgUrl (pic) {
                return require('@/assets/blog_posts/science/NeverPure/' + pic)
            }
        },
    }
</script>